...
include_once '../templates/navbar-admin.php';

// Get the admin ID from session
$adminID = $_SESSION["admin_id"];

// Fetch admin details
$adminQuery = "SELECT * FROM Admin WHERE AdminID = ?";
$stmt = prepare($adminQuery);
...
// Fetch user details
$userQuery = "SELECT Username, Email, last_login FROM User WHERE Admin_AdminID = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["change_password"])) {
    ...
    $passwordQuery = "SELECT Password FROM User WHERE Admin_AdminID = ?";
    ...
    if (!$passwordCorrect) {
        ...
        // Update the password
        $updatePasswordQuery = "UPDATE User SET Password = ? WHERE Admin_AdminID = ?";
        $stmt = prepare($updatePasswordQuery);
        $stmt->bind_param("ss", $hashedPassword, $adminID);
    ...
    <div class="profile-header">
        <div class="d-flex flex-column flex-md-row align-items-center">
            ...
            <div class="text-center text-md-start">
                <h2><?php echo htmlspecialchars($adminData['Name']); ?></h2>
                <p class="mb-1"><i class="fas fa-id-card me-2"></i>Admin ID: <?php echo htmlspecialchars($adminData['AdminID']); ?></p>
                <p class="mb-1"><i class="fas fa-phone me-2"></i>Contact: <?php echo htmlspecialchars($adminData['Contact_Number']); ?></p>
            </div>
        </div>
    </div>
            ...
            <ul class="nav nav-tabs" id="profileTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="info-tab" data-bs-toggle="tab" data-bs-target="#info-content" type="button" role="tab" aria-controls="info-content" aria-selected="true">
                        <i class="fas fa-user me-2"></i>Administrator Information
                    </button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="profileTabContent">
                ...
                <div class="tab-pane fade show active" id="info-content" role="tabpanel" aria-labelledby="info-tab">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="info-card">
                                <h5><i class="fas fa-user-shield me-2"></i>Admin Details</h5>
                                
                                <div class="info-item">
                                    <div class="info-label">Full Name</div>
                                    <div class="info-value"><?php echo htmlspecialchars($adminData['Name']); ?></div>
                                </div>
                                
                                <div class="info-item">
                                    <div class="info-label">Admin ID</div>
                                    <div class="info-value"><?php echo htmlspecialchars($adminData['AdminID']); ?></div>
                                </div>
                                
                                <div class="info-item">
                                    <div class="info-label">Contact Number</div>
                                    <div class="info-value"><?php echo htmlspecialchars($adminData['Contact_Number']); ?></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tab-pane fade" id="security-content" role="tabpanel" aria-labelledby="security-tab">
                    ...
                    <div class="info-card">
                        <h5><i class="fas fa-user-shield me-2"></i>Administrator Security</h5>
                        
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <i class="fas fa-info-circle text-info me-2"></i>
                                As an administrator, you have elevated privileges in the system
                            </li>
                            <li class="list-group-item">
                                <i class="fas fa-info-circle text-info me-2"></i>
                            ...
                            <li class="list-group-item">
                                <i class="fas fa-info-circle text-info me-2"></i>
                                Always verify identity before resetting user passwords
                            </li>
                            <li class="list-group-item">
                                <i class="fas fa-info-circle text-info me-2"></i>
                                Implement and follow administrative security best practices
                            </li>
                        </ul>
                    </div>
                </div>
